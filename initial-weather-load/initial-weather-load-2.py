...
try:
    ...
    try:
        ...
        stations_batch_2 = stations[900:1800]
        print(f"batch 2: processing stations 900-1799: ({len(stations_batch_2)} stations)")
    ...
    for idx, station in enumerate(stations_batch_2):
        station_name = station['station_name']
        lat = station['lat']
        lon = station['lon']
        
        if (idx + 1) % 100 == 0:
            print(f"processing station {idx + 1}/{len(stations_batch_2)}")
